		...
		<div class="container-fluid">
				...
				<div id="navbar" class="row">
					<div class="col-xs-12 hidden-sm">
						<a id="btnLeftNav" class="btn btn-success pull-left">Profile <span id="leftGlyphicon" class="glyphicon glyphicon-chevron-right"></span></a>
						<a id="btnRightNav" class="btn btn-success pull-right"><span id="rightGlyphicon" class="glyphicon glyphicon-chevron-left"></span> Message Center</a>
					</div>
				</div> 
